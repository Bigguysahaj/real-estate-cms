...
const navItems: NavItem[] = [
  ...
  { href: "/dashboard/blog", icon: PaperclipIcon, label: "Blog" },
  ...
  {
    href: "/dashboard/property-enquiry",
    icon: SmartphoneNfcIcon,
    label: "Property Enquiry",
  },
  { href: "/dashboard/blog-enquiry", icon: NotebookPen, label: "Blog Enquiry" },
  {
    href: "/dashboard/brochure-enquiry",
    icon: ScrollTextIcon,
    label: "Brochure Enquiry",
  },
  {
  ...
  { href: "/dashboard/pages", icon: Layers3Icon, label: "Pages" },
  { href: "/dashboard/property", icon: BrickWallIcon, label: "Property" },
]
